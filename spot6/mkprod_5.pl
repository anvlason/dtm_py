...
my $INDIR="G:\\Departments\\production\\plproduction\\SPOT6\\THR5";
my $OUTDIR ="G:\\Departments\\production\\plproduction\\SPOT6_OUT\\THR5"; mkdir($OUTDIR);
my $BINDIR="C:\\app\\bin";
my $DEMONDIR = "c:\\app\\BIN_IC645";
