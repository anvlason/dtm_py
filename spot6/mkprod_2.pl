...
my $INDIR="G:\\Departments\\production\\plproduction\\SPOT6\\THR2";
my $OUTDIR ="G:\\Departments\\production\\plproduction\\SPOT6_OUT\\THR2"; mkdir($OUTDIR);
my $BINDIR="C:\\app\\bin";
my $DEMONDIR = "c:\\app\\BIN_IC642";
