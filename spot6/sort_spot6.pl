...
use strict;
use FIle::Copy;
my $INDIR = 'G:\Departments\production\plproduction\SPOT6_IN';
my @OUTDIR=("G:\\Departments\\production\\plproduction\\SPOT6\\THR1","G:\\Departments\\production\\plproduction\\SPOT6\\THR2","G:\\Departments\\production\\plproduction\\SPOT6\\THR3","G:\\Departments\\production\\plproduction\\SPOT6\\THR4","G:\\Departments\\production\\plproduction\\SPOT6\\THR5");
my $th_count = 5;
...
foreach my $proddir(glob("$INDIR\\DS_SPOT*")) {
 if(-d $proddir) {
	if($dir1 < $max_size) {
